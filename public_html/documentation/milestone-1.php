<DOCTYPE html>
	<html lang="en">
		<head>
			<meta charset="UTF-8">
			<title>Milestone 1 for PWP </title>
		</head>
		<body>
			<h1>Milestone 1</h1>
			...
			<h2>Purpose, Audience, Goal</h2>
				...
				<P><strong>Purpose:</strong> The purpose of this website is to display my skills as a full stack web developer.</P>
			   <P><strong>Audience:</strong>This website is geared towards people that are starting a business and need a website or have an establish business and want to do a makeover of their web site to spice things up. </P>
				<p><strong>Goal:</strong>The primary goal of this website is to draw clients in and create business contacts/opportunities.</p>
